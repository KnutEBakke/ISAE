...
PPS: You should also change the range of the for-loop in test-heap-complexity.c to 120000 instead of 12000000 before running it with Valgrind.
PPPS: If you want to test with a different number of particles, using the write-doc command may save you some time.
